    ...
    public class CombinationsGetter : IItemssGetter
    {
        ...
        private List<ItemViewModel> GetItems()
        {
            ...
            { 
                ...
                new ItemViewModel("Algae", "../Images/algae.png", 3, "Basic Life"),
                ...
                new ItemViewModel("Electricity", "../Images/electricity.png", 4, "Energy"),
                new ItemViewModel("Glass", "../Images/glass.png", 4, "Earth"),
                new ItemViewModel("Boiler", "../Images/boiler.png", 4, "Technology"),
                new ItemViewModel("Clay", "../Images/clay.png", 4, "Earth"),
                new ItemViewModel("Moss", "../Images/moss.png", 4, "Basic Life"),
                new ItemViewModel("Plankton", "../Images/plankton.png", 4, "Basic Life"),
                new ItemViewModel("Seeds", "../Images/seeds.png", 4, "Plant"),
                new ItemViewModel("Dinosaur", "../Images/dinosaur.png", 4, "Creatures"),
                new ItemViewModel("Bird", "../Images/bird.png", 4, "Animal"),
                new ItemViewModel("Robot", "../Images/robot.png", 4, "Technology"),
                new ItemViewModel("Mushroom", "../Images/mushroom.png", 4, "Basic Life"),
                new ItemViewModel("Iron Man", "../Images/ironman.png", 4, "Human"),
                new ItemViewModel("Corpse", "../Images/corpse.png", 4, "Human"),
            };
        ...
        private List<Combination> GetCombinations()
        {
            var combos = new List<Combination>()
            {
                ...
                new Combination("Water", "Life", "Algae", 3),
                ...
                new Combination("Metal", "Energy", "Electricity", 4),
                new Combination("Sand", "Fire", "Glass", 4),
                new Combination("Metal", "Gayser", "Boiler", 4),
                new Combination("Swamp", "Sand", "Clay", 4),
                new Combination("Algae", "Swamp", "Moss", 4),
                new Combination("Water", "Bacteria", "Plankton", 4),
                new Combination("Life", "Sand", "Seeds", 4),
                new Combination("Egg", "Earth", "Dinosaur", 4),
                new Combination("Air", "Egg", "Bird", 4),
                new Combination("Water", "Bacteria", "Plankton", 4),
                new Combination("Metal", "Life", "Robot", 4),
                new Combination("Human", "Metal", "Iron Man", 4),
                new Combination("Weeds", "Earth", "Mushroom", 4),
                new Combination("Human", "Fire", "Corpse", 4),
            };
